...
Interactive, 100% in-browser Kubernetes learning lab. Open [`kubelab.html`](kubelab.html) in a browser (no cluster, no build step).

- Internals: architecture, animated request flow, operators, kubectl playground, interview prep
